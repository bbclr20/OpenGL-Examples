...
void My_Init() {
	...
	char** vsSource = LoadShaderSource("../Asset/Image_Processing.vs.glsl");
	char** fsSource = LoadShaderSource("../Asset/Image_Processing.fs.glsl");
	...
	TextureData tdata = Load_png("../Asset/hawk.png");
