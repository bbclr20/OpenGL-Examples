...
void My_Init() {
	...
	char** vsSource = LoadShaderSource("../Asset/HeightMap/height_map.vs.glsl");
	char** tcsSource = LoadShaderSource("../Asset/HeightMap/height_map.tcs.glsl");
	char** tesSource = LoadShaderSource("../Asset/HeightMap/height_map.tes.glsl");
	char** gsSource = LoadShaderSource("../Asset/HeightMap/height_map.gs.glsl");
	char** fsSource = LoadShaderSource("../Asset/HeightMap/height_map.fs.glsl");
	...
	// texture setting
	TextureData tdata = Load_png("../Asset/HeightMap/heightmap.png");
	...
	tdata = Load_png("../Asset/HeightMap/groundtexture.jpg");
