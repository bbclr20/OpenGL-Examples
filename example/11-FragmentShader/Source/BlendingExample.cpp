...
const GLuint defalut_w = 800;
const GLuint defalut_h = 800;


int sfactor = GL_SRC_ALPHA;
int dfactor = GL_ONE;

string sfactor_s = "GL_SRC_ALPHA";
...
void My_Init() {
	...
	char** vsSource = LoadShaderSource("../Asset/Blending_Example.vs.glsl");
	char** fsSource = LoadShaderSource("../Asset/Blending_Example.fs.glsl");
	...
	// texture
	TextureData tdata = Load_png("../Asset/wood.png");
	...
	TextureData tdata1 = Load_png("../Asset/light.png");
